...
@Slf4j
@Repository
public class CWJobsRepositoryImpl implements CWJobsRepository {

    private static final String URL = "https://www.cwjobs.co.uk";
        ...
        for(Element element : elements){
            ...
            result.add(
                    JobSearchResult.builder()
                            ...
                            .providerName( ProviderName.CW_JOBS.providerName )
